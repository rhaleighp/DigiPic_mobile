...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun setupBottomNavigation() {
        ...
        val challengesIcon = findViewById<ImageView>(R.id.nav_challenges)
        val galleryIcon = findViewById<ImageView>(R.id.nav_gallery)
        val profileIcon = findViewById<ImageView>(R.id.nav_profile)
        val settingsIcon = findViewById<ImageView>(R.id.nav_settings)
